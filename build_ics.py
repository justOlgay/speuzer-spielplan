...
if (EINZELN) { const h = document.getElementById("hinweis-kinder"); if (h) h.remove(); document.getElementById("meta").hidden = true; document.querySelector(".fuss").hidden = true; document.querySelector(".kapitel").hidden = true; }
